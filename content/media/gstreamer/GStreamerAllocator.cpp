...
void
moz_gfx_memory_allocator_set_reader(GstAllocator *aAllocator, mozilla::GStreamerReader* aReader)
{
...
{
  NS_ASSERTION(gst_memory_is_type(aMemory, "moz-gfx-image"), "Should be a gfx image");
...
moz_gfx_buffer_pool_reset_buffer (GstBufferPool* aPool, GstBuffer* aBuffer)
{
  ...
  NS_ASSERTION(gst_memory_is_type(mem, "moz-gfx-image"), "Should be a gfx image");
  moz_gfx_memory_reset((MozGfxMemory *) mem);
